...
<div id="logo"><a href="http://<?{$smarty.const.SITE_DOMAIN}?>/"><img alt="BTC123_LOGO" src="http://<?{$smarty.const.SITE_DOMAIN}?>/<?{$smarty.const.SITE_LOGO}?>" /></a></div>
<style>
...
<p><a href="<?{$defaultsearch.url}?>"><img alt="search_engine" src="../<?{$defaultsearch.img_url}?>" border="0"></a>
...
<div class="tree"><a href="http://<?{$smarty.const.SITE_DOMAIN}?>/" target="_top">btc123导航首页</a> >> <a href="http://<?{$smarty.const.SITE_DOMAIN}?>/<?{$smarty.const.HTML_PATH}?><?{$c_name.stpHtmlName}?>"><?{$c_name.stpName}?></a></div>
...
<?{/if}?>
  ...
  <div class="home"><a href="http://<?{$smarty.const.SITE_DOMAIN}?>" class="back">返回BTC123首页</a>&nbsp;|&nbsp;<?{$smarty.const.COUNT_CODE}?></div>
