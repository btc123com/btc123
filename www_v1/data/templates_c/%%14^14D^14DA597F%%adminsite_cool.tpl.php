<?php /* Smarty version 2.6.18, created on 2012-06-20 15:47:14
         compiled from admin/adminsite_cool.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/adminsite_cool.tpl', 455, false),array('modifier', 'substr', 'admin/adminsite_cool.tpl', 493, false),)), $this); ?>
...
siteUrl = urlf(siteUrl);
	...
	$.getJSON("site_cool.php?a=edit&siteID[]="+escape(siteID)+"&siteColor[]="+escape(siteColor)+"&siteSort[]="+escape(siteSort)+"&siteName[]="+escape(siteName)+"&siteUrl[]="+escape(siteUrl)+"&siteStatus[]="+escape(siteStatus)+"&stpID[]=<?php echo $this->_tpl_vars['typeid']; ?>
", function(json){
...
function doTypeLineEdit(rid,nid){
	...
	$.getJSON("site_cool.php?a=edittype&stpID[]="+escape(stpID)+"&stpSort[]="+escape(stpSort)+"&stpName[]="+escape(stpName)+"&stpHtmlName[]="+escape(stpHtmlName)+"&stpParentID=<?php echo $this->_tpl_vars['typeid']; ?>
", function(json){
...
function submitTypeAllEdit(){
	...
	$("#typedatatable").find("tr").each(function(){
		...
		if(trid.substr(0,13)=='type_new_row_'){
			...
			url += "&stpID[]="+escape(stpID)+"&stpSort[]="+escape(stpSort)+"&stpName[]="+escape(stpName)+"&stpHtmlName[]="+escape(stpHtmlName)+"&stpParentID=<?php echo $this->_tpl_vars['typeid']; ?>
";
		}
	});
	if(url!=''){
...
" style="width:20px; height:20px; float:left; background:url(images/penboard.gif) no-repeat 0 2px; text-indent:-999px;cursor:pointer" title="选择颜色" onclick="showcolorbord(<?php echo $this->_tpl_vars['arrSite'][$this->_sections['loop']['index']]['siteID']; ?>
,'');">色</label></td>
...
)"><img src="images/ico_del.gif" title="删除"></a><a href="./adminsite_cool.php?typeid=<?php echo $this->_tpl_vars['allType'][$this->_sections['loop']['index']]['stpID']; ?>
