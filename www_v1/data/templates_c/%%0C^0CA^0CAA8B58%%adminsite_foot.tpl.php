<?php /* Smarty version 2.6.18, created on 2012-06-20 15:47:17
         compiled from admin/adminsite_foot.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/adminsite_foot.tpl', 460, false),array('modifier', 'substr', 'admin/adminsite_foot.tpl', 500, false),)), $this); ?>
...
siteUrl = urlf(siteUrl);
	...
	$.getJSON("site_foot.php?a=edit&siteID[]="+escape(siteID)+"&siteColor[]="+escape(siteColor)+"&siteSort[]="+escape(siteSort)+"&siteName[]="+escape(siteName)+"&siteUrl[]="+escape(siteUrl)+"&siteStatus[]="+escape(siteStatus)+"&stpID[]=<?php echo $this->_tpl_vars['typeid']; ?>
", function(json){
...
function doTypeLineEdit(rid,nid){
	...
	$.getJSON("site_foot.php?a=edittype&stpID[]="+escape(stpID)+"&stpSort[]="+escape(stpSort)+"&stpName[]="+escape(stpName)+"&stpHtmlName[]="+escape(stpHtmlName)+"&stpParentID=<?php echo $this->_tpl_vars['typeid']; ?>
", function(json){
...
)"><img src="images/ico_del.gif" title="删除"></a><a href="./adminsite_foot.php?typeid=<?php echo $this->_tpl_vars['allType'][$this->_sections['loop']['index']]['stpID']; ?>
