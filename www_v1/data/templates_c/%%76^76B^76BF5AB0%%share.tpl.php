<?php /* Smarty version 2.6.18, created on 2013-06-22 23:24:25
         compiled from i/share.tpl */ ?>
...
<body class="bg">
  <div id="warp">
    <div id="top">
      <div class="logo"><font color="orange"><a href="http://<?php echo @SITE_DOMAIN; ?>
" target="_blank"><img src="../static/images/logo_180_60.png" title="<?php echo @SITE_NAME; ?>
" /></a></font></div>
      <div class="add">
      <?php if ($this->_tpl_vars['uname'] == ''): ?>
      <span>加入&nbsp;<font color="orange"><?php echo @SITE_DOMAIN; ?>
</font>&nbsp;一起分享潮流 <a href="javascript:;" onclick="showform();">登录</a></span>&nbsp;|&nbsp;<span><a href="http://<?php echo @SITE_DOMAIN; ?>
/i/share.php?a=sreg&url=<?php echo $this->_tpl_vars['url']; ?>
&title=<?php echo $this->_tpl_vars['title']; ?>
" target="_self">注册</a></span>
      <?php else: ?>
      <span>你正在使用 <font color=blue><?php echo $this->_tpl_vars['uname']; ?>
</font> 帐号</span>&nbsp;|&nbsp;<span><a href="http://<?php echo @SITE_DOMAIN; ?>
/i/share.php?a=slogout&url=<?php echo $this->_tpl_vars['url']; ?>
&title=<?php echo $this->_tpl_vars['title']; ?>
" target="_self">换个帐号？</a></span>
      <?php endif; ?>
      </div>
    </div>
    <div id="main">
...
/i/share.php?a=add" method="post" onsubmit="return checkinfo();">
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td width="50"><div align="center">标题：</div></td>
         <td>
	   <input name="title" type="text" id="title" value="<?php echo $this->_tpl_vars['title']; ?>
" onkeyup="checktitle();"/></td>
       </tr>
       <tr>
         <td width="50"><div align="center" style="margin-top:5px">网址：</div></td>
         <td>
           <input name="url" type="text" id="url" value="<?php echo $this->_tpl_vars['url']; ?>
"  style="margin-top:7px"/></td>
       </tr>
       <tr>
         <td width="50"><div align="center" style="margin-top:5px">分类：</div></td>
<?php if ($this->_tpl_vars['navArr']): ?>
         <td height="38"><select name="nav" id="nav" style="border:1px solid #abc4e2; height:20px; line-height:20px; font-size:14px; width:99px; ">
         <?php $_from = $this->_tpl_vars['navArr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['l']):
?>
         <option value="<?php echo $this->_tpl_vars['l']['navID']; ?>
"><?php echo $this->_tpl_vars['l']['navName']; ?>
</option>
...
<?php endif; ?>
       ...
       <tr>
         <td>&nbsp;<input type="hidden" value="<?php echo $this->_tpl_vars['uname']; ?>
" id="uname"/></td>
         <td><input type="image" src="http://<?php echo @SITE_DOMAIN; ?>
/static/images/post.jpg" style="width:81px; height:38px" class="sumbit" name="add"/></td>
       </tr>
     </table>
</form>
    </div>
...
/i/share.php?act=slogin" method="post">
...
/i/index.php?a=getpwd" style="color:#06c">忘记密码？</a>
