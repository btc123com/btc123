<?php /* Smarty version 2.6.18, created on 2014-04-09 07:33:36
...
友情链接（有点无耻，我把这条放在了最后，大家互相支持 ^_^）。<a href="javascript:;" onclick="$('#show1').show();$('#show2').show()">(查看友情链接示例)</a></li>
  </ul>
...
/<?php echo @SITE_LOGO; ?>
" width="180" height="60" border="0" /></a></textarea>
