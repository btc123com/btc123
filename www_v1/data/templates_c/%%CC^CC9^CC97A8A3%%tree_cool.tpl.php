<?php /* Smarty version 2.6.18, created on 2012-06-20 15:47:14
         compiled from admin/tree_cool.tpl */ ?>
...
?>
<li><?php if ($this->_tpl_vars['trees']['child']): ?><img style="cursor:pointer" title="展开/收缩下级菜单" src="./images/arrow_file.jpg" id="image_<?php echo $this->_tpl_vars['trees']['stpID']; ?>
...
"><?php endif; ?><span><a title="查看详细站点和下级菜单信息" href="adminsite_cool.php?typeid=<?php echo $this->_tpl_vars['trees']['stpID']; ?>
" target="innermainFrame" onclick="clickleaf(<?php echo $this->_tpl_vars['trees']['stpID']; ?>
)"><?php echo $this->_tpl_vars['trees']['stpName']; ?>
