<?php /* Smarty version 2.6.18, created on 2012-06-20 15:32:10
         compiled from admin/adminsite_famous.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/adminsite_famous.tpl', 243, false),array('modifier', 'substr', 'admin/adminsite_famous.tpl', 282, false),)), $this); ?>
...
" target="_blank"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrSite'][$this->_sections['loop']['index']]['siteUrl'])) ? $this->_run_mod_handler('substr', true, $_tmp, 0, 60) : substr($_tmp, 0, 60)); ?>
        ...
        <td class="tr_a">
        	<?php if ($this->_tpl_vars['arrSite'][$this->_sections['loop']['index']]['siteStatus'] == 1): ?>正常<?php else: ?><font color="#FF0000">锁定</font><?php endif; ?>
        </td>
